// TODO: Make this file not so full of duplication with the LiveStream component
  ...
  if (!appContext.event?.streamEmbedLink) {
    ...
    content = (
      ...
      <div onClick={onClickDiv}>
        <StreamIFrame
          src={`https://frc-events.firstinspires.org/${appContext.season}/${appContext.event.eventCode}/rankings/live`}
          pointer={pointer}
        />
      </div>
    );
